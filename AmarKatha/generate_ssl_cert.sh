...
show_instructions() {
    ...
    echo ""
    echo "2. Run with HTTPS (outside Docker):"
    echo "   python run.py --https --port 5002"
    echo ""
    echo "   Local Docker uses HTTP on port 5000 — see docs/docker.md"
    echo ""
    echo "3. Access at: https://localhost:5002 (or your chosen port)"
    echo ""
